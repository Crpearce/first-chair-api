...
app.locals.resorts = [
  ...
  },
  {
    ...
    logo: "https://aspenchamber.org/sites/default/files/venue-images/0fe78335-d4e3-4f7d-8707-f1effcf3b741.png",
  ...
  },
  {
    ...
    acres: 1040,
    ski_Map:
      "https://www.aspensnowmass.com/-/media/aspen-snowmass/images/image-cta-with-title-and-description/image-cta-card-wide/winter/2021-22/highlands-trail-map-image-cta-wide-07302021.jpg?mw=1600&mh=488&hash=CA6EFCC3F2C92E0515D6212AD918D133",
    lifttix:
      "https://shop.aspensnowmass.com/s/all-lift-tickets/c/lift-tickets-3",
    live_Cam:
  ...
  },
  {
    ...
    acres: 100,
    ski_Map:
      "https://www.steamboatsprings.net/ImageRepository/Document?documentID=20469",
  ...
  },
  {
    ...
    acres: 20,
    ski_Map:
      "https://images.squarespace-cdn.com/content/v1/5dade5d6f3de04278ab5ade9/1572538676771-GIKU5P0148RTON4N579G/image-asset.jpeg?format=1000w",
  ...
  },
  {
    id: 13,
    name: "Keystone",
    overview: `Located 90 minutes from Denver, Keystone is comprised of 3 mountains with a summit elevation of 12,408 ft. This resort features one of Colorado's largest terrain night parks. With an abundance of activities for every season, a host of restaurant options from casual to fine dining, and plenty of lodging options, Keystone has it all.`,
    region: "Summit County",
  ...
  },
  {
    ...
    lifttix:
      "https://www.powderhorn.com/index.php/plan-purchase/purchase/lift-tickets",
  ...
  },
  {
    ...
    name: "Purgatory",
    overview:
      "Purgatory Resort (formerly Durango) is a ski vacation destination located north of Durango in the San Juan Mountains of southwestern Colorado. The mountain offers terrain for all abilities, two terrain parks and a kids play area. The historic town of Durango is located 25 miles south where you can find an array of shopping, dining and lodging.",
    ...
    live_Cam:
      "https://www.purgatory.ski/mountain/weather-conditions-webcams/webcams/",
    hours: 7,
    pass: "",
    type: "",
  },
  ...
  },
  {
    ...
    acres: 1000,
    ski_Map:
      "https://coloradopirateadventures.com/templates/yootheme/cache/b4/greater-alpine-loop-map-1024x740_orig-b4a06357.jpeg",
  ...
  },
  {
    ...
    acres: 80,
    ski_Map:
      "https://res.cloudinary.com/liftopia/image/upload/c_fit,d_defaults:default_logo_1.png,f_auto,h_980,q_auto,w_980/v1/production/trail_maps/825584c47174532bc52901611fa3fce6.jpg",
  ...
  },
  {
    ...
    name: "Snowmass",
    overview:
      "Snowmass is part of an expansive winter playground with four unique neighbouring mountains (Aspen, Aspen Highlands, Snowmass and Butternut) with 5,527 total acres of terrain. Snowmass is the largest of the four areas being bigger than the other three combined and the crowning jewel for Colorado snow.",
    region: "Pitkin County",
  ...
  },
  {
    ...
    overview:
      "Steamboat Powdercats will put together a snowcat trip that should provide you with an excellent day in the backcountry of Buffalo Pass on the Eastern side of Steamboat Springs.",
    region: "Routt County",
    ...
    acres: 1500,
    ski_Map:
      "https://beaconguidebooks.com/wp-content/uploads/Buff-Pass-Map-Sample-Section-800-x-800.jpg",
...
app.post("/api/v1/runs", (request, response) => {
  ...
  if (!name || !runName || !difficulty) {
    return response.status(422).json({
      error:
        "Expected format { name: <String>, date: <String>, time: <String>, number: <Number> }. You are missing a required parameter.",
    });
  }
